...
func (this *DB_GamMatchLVMgr) reunmarshal(data []byte) error {
	newDatas := &server.DB_GamMatchLVArray{}
...
func (this *DB_GamMatchLVMgr) arrangeData() {
	if this.Datas == nil {
		return
	}
...
func (this *DB_GamMatchLVMgr) GetData(id int32) *server.DB_GamMatchLV {
