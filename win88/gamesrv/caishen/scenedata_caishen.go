...
func (this *CaiShenSceneData) init() bool {
	...
	if this.jackpot.JackpotFund <= 0 {
		this.jackpot.JackpotFund = int64(params[rule.CAISHEN_JACKPOT_InitJackpot] * this.DbGameFree.GetBaseScore())
	}
...
func (this *CaiShenSceneData) broadcastJackpot() {
...
func (this *CaiShenSceneData) AfterTimer() {
...
func (this *CaiShenSceneData) PushVirtualDataToWorld() {
	var isVirtualData bool
	var jackpotParam = this.DbGameFree.GetJackpot() // 奖池参数
	var jackpotInit = int64(jackpotParam[rule.CAISHEN_JACKPOT_InitJackpot] * this.DbGameFree.GetBaseScore())
