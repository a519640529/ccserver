...
func (this *DB_GameSubsidyMgr) reunmarshal(data []byte) error {
	newDatas := &server.DB_GameSubsidyArray{}
...
func (this *DB_GameSubsidyMgr) arrangeData() {
	if this.Datas == nil {
		return
	}
...
func (this *DB_GameSubsidyMgr) GetData(id int32) *server.DB_GameSubsidy {
