...
func (this *EasterIslandSceneData) init() bool {
	...
	if this.jackpot.JackpotFund <= 0 {
		this.jackpot.JackpotFund = int64(params[rule.EL_JACKPOT_InitJackpot] * this.DbGameFree.GetBaseScore())
	}
...
func (this *EasterIslandSceneData) AfterTimer() {
...
func (this *EasterIslandSceneData) PushVirtualDataToWorld() {
	var isVirtualData bool
	var jackpotParam = this.DbGameFree.GetJackpot() // 奖池参数
	var jackpotInit = int64(jackpotParam[rule.EL_JACKPOT_InitJackpot] * this.DbGameFree.GetBaseScore())
