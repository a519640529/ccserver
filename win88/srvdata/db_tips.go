...
func (this *DB_TipsMgr) reunmarshal(data []byte) error {
	newDatas := &server.DB_TipsArray{}
...
func (this *DB_TipsMgr) arrangeData() {
	if this.Datas == nil {
		return
	}
...
func (this *DB_TipsMgr) GetData(id int32) *server.DB_Tips {
